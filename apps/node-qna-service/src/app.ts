...
import { errorHandlerMiddleware, NotFoundError } from 'stackoverflow-server-common'
...
app.use('/api/qna/v1/api-docs', swaggerConfig.serve, swaggerConfig.setup)
app.use(expressjwt(expressJwtOptions).unless({ path: publicRoutes }))
app.use('/api/qna/v1', router)
